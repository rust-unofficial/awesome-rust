...
* Mocking and Test Data
  ...
  * [synth](https://github.com/shuttle-hq/synth/) — Generate database data declaratively. ![build](https://github.com/shuttle-hq/synth/workflows/test/badge.svg?branch=master) 
* Mutation Testing
