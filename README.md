...
* [Sentrix](https://github.com/sentrix-labs/sentrix) - A Layer 1 blockchain implementation in Rust featuring DPoS+BFT consensus, EVM compatibility (revm), 1-second blocks, and native staking + token operations.
