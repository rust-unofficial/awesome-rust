...
* [GT Office](https://github.com/Laplace-bit/GT-Office) - Native multi-agent collaborative workspace to orchestrate AI CLI tools (Claude Code, Codex, Gemini CLI) with persistent workspaces and agent-to-agent communication [![CI](https://github.com/Laplace-bit/GT-Office/actions/workflows/ci.yml/badge.svg)](https://github.com/Laplace-bit/GT-Office/actions/workflows/ci.yml)
