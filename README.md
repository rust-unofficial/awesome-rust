...
* [hound](https://crates.io/crates/hound) — A WAV  and decoding library [![build badge](https://api.travis-ci.org/ruuda/hound.svg?branch=master)](https://travis-ci.org/ruuda/hound)
