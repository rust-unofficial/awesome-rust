...
* [CCHub](https://github.com/Moresl/cchub) - A Claude Code ecosystem management platform built with Tauri v2. Manages MCP servers, config profiles, skills, plugins, workflows, and hooks through a unified desktop GUI.
