...
* [rekurt/prt](https://github.com/rekurt/prt) [[prt](https://crates.io/crates/prt)] — Real-time TUI for monitoring network ports, an interactive alternative to lsof/ss/netstat with alerts, firewall blocking, and container awareness
