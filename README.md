...
* [rustnew/Lift](https://github.com/rustnew/Lift) [[lift-core](https://crates.io/crates/lift-core)] - Unified compiler framework for AI and quantum computing: a single SSA IR for tensor ops, quantum gates, and classical-quantum hybrids, with 13 optimisation passes, O0-O3 pipelines, and LLVM IR / ONNX / OpenQASM 3.0 backends. [![CI](https://github.com/rustnew/Lift/actions/workflows/ci.yml/badge.svg)](https://github.com/rustnew/Lift/actions/workflows/ci.yml)
