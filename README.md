...
* [samvallad33/vestige](https://github.com/samvallad33/vestige) - Memory system for AI coding agents. Retroactive backfill ranks earlier precursors of a failure, the composed graph records reasoning events and surfaces never-tried combinations of past decisions, FSRS-6 decay, retrieval receipts, 15 MCP tools. Single Rust binary.
#### Genetic algorithms
