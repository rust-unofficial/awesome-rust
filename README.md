...
* [ekhodzitsky/gigastt](https://github.com/ekhodzitsky/gigastt) [[gigastt](https://crates.io/crates/gigastt)] - Local, offline Russian speech-to-text server (GigaAM v3, ONNX Runtime) with REST, WebSocket and SSE streaming APIs, a CLI, and Swift/Kotlin/Python/Node bindings [![CI](https://github.com/ekhodzitsky/gigastt/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/ekhodzitsky/gigastt/actions/workflows/ci.yml)
