...
* [Chimely](https://github.com/dodopayments/chimely) - Self-hostable in-app notification inbox infrastructure. One Rust binary (axum) plus Postgres and Redis, with a drop-in `<Inbox />` React component. Self-hosted alternative to Knock, Courier, MagicBell, and Novu.
