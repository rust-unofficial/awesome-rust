...
* [frs](https://crates.io/crates/frs) - Rename files with RegEx patterns [![Workflow Status](https://img.shields.io/github/workflow/status/TheAlgorythm/frs/Rust)](https://github.com/TheAlgorythm/frs/actions?query=workflow%3ARust)
