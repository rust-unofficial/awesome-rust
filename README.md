...
* [nucket/nekoai](https://github.com/nucket/nekoai) - AI-powered desktop pet, a modern successor to the 1988 Neko. Animated sprite walks across your screen, remembers your projects, and chats via a speech bubble using Claude, OpenAI, Gemini, NVIDIA NIM, or local Ollama. Built with Tauri 2 + Rust + React, under 10 MB, cross-platform (Windows, macOS, Linux + Wayland). [![CI](https://github.com/nucket/nekoai/actions/workflows/ci.yml/badge.svg)](https://github.com/nucket/nekoai/actions/workflows/ci.yml)
