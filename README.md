...
* [qnote](https://github.com/Omibranch/qnote) - Minimal frameless desktop notepad for Linux with Markdown support, PDF export via Typst, OCR, and automatic version history. Built with Tauri 2. [![Build](https://github.com/Omibranch/qnote/actions/workflows/release.yml/badge.svg)](https://github.com/Omibranch/qnote/actions/workflows/release.yml)
