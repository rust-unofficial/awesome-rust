...
* [NORA](https://github.com/getnora-io/nora) - Multi-protocol artifact registry (Docker, Maven, npm, Cargo, PyPI) in a single 32MB binary. Built with Axum and Tokio. [![CI](https://github.com/getnora-io/nora/actions/workflows/ci.yml/badge.svg)](https://github.com/getnora-io/nora/actions/workflows/ci.yml)
