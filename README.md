...
* Learning
  ...
  * [Build your own X (CodeCrafters.io)](https://codecrafters.io) — Rust mastery, by recreating Redis, Docker, Git, and SQLite
  * [Build your own X (repository)](https://github.com/codecrafters-io/build-your-own-x) — A list of _Build your own X_ style exercises in Rust and other languages
