...
* [Muvon/octomind](https://github.com/Muvon/octomind) [[octomind](https://crates.io/crates/octomind)] - Open-source, model-agnostic AI agent runtime with community tap registry, MCP support with runtime self-extension, 13+ providers, and adaptive compression. Install agents, not frameworks. [![Build Status](https://github.com/Muvon/octomind/actions/workflows/ci.yml/badge.svg)](https://github.com/Muvon/octomind/actions/workflows/ci.yml)
