...
* HTTP Server
  ...
  * [Haro](https://github.com/shellfly/haro) — A simple and synchronous web framework for Rust [![build badge](https://github.com/shellfly/haro/actions/workflows/ci.yml/badge.svg)](https://github.com/shellfly/haro/actions)
* Miscellaneous
