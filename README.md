...
* [mdserve](https://crates.io/crates/mdwatch) - A simple command-line tool to preview Markdown files in a web browser with auto-reload on save, written in actix-web
