...
* [BartoszOsiej/talus-process-monitor](https://github.com/BartoszOsiej/talus-process-monitor) [[process-monitor](https://crates.io/crates/process-monitor)] - eBPF-based ransomware detection for Linux: kernel-level execve/openat tracing, sliding-window file-open scoring, entropy analysis, and automated SIGKILL response. Single static binary [![crate](https://img.shields.io/crates/v/process-monitor?logo=rust)](https://crates.io/crates/process-monitor)
