...
* [replicadse/senile](https://github.com/replicadse/senile) — A structuring ToDo statement collector with support for custom formats.\
[![crates.io](https://img.shields.io/crates/v/senile.svg)](https://crates.io/crates/senile) [![crates.io](https://img.shields.io/crates/d/senile?label=crates.io%20downloads)](https://crates.io/crates/senile) [![website](https://img.shields.io/badge/AUR-package-blue)](https://aur.archlinux.org/packages/senile/) [![website](https://img.shields.io/docker/pulls/replicadse/senile)](https://hub.docker.com/repository/docker/replicadse/senile) [![build badge](https://github.com/replicadse/senile/workflows/pipeline/badge.svg?branch=master)](https://github.com/replicadse/senile/actions)
...
desktop applications with a web frontend, powered by [WRY](https://github.com/tauri-apps/wry). [![test library](https://img.shields.io/github/workflow/status/tauri-apps/tauri/test%20library?label=test%20library)](https://github.com/tauri-apps/tauri/actions?query=workflow%3A%22test+library%22)
