...
* [raftio/gamm](https://github.com/raftio/gamm) - Git Account Manager that automatically switches git user identity per repository using profiles and a pre-commit hook.
