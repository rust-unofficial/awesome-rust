...
* [casperkwok/pdfmuse](https://github.com/casperkwok/pdfmuse) [[pdfmuse-core](https://crates.io/crates/pdfmuse-core)] - Deterministic PDF/DOCX parser for RAG/LLMs with byte-identical Python, Node and WASM bindings. [![build badge](https://github.com/casperkwok/pdfmuse/actions/workflows/ci.yml/badge.svg)](https://github.com/casperkwok/pdfmuse/actions/workflows/ci.yml)
