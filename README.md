...
* [AyoubTadlaoui/npmguard](https://github.com/AyoubTadlaoui/npmguard) - Pre-install risk gate for npm packages with an MCP tool for AI coding agents. Pulls registry + OSV.dev + GitHub signals in parallel and refuses known-malicious or typosquatted versions before lifecycle scripts run.
