...
* [dakera-ai/dakera-cli](https://github.com/Dakera-AI/dakera-cli) [[dakera-cli](https://crates.io/crates/dakera-cli)] - CLI for managing a self-hosted AI agent memory server — inspect memories, query vectors, manage namespaces, and configure temporal decay from the terminal. [![CI](https://github.com/Dakera-AI/dakera-cli/actions/workflows/ci.yml/badge.svg)](https://github.com/Dakera-AI/dakera-cli/actions/workflows/ci.yml)
