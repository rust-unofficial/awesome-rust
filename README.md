...
* [OpenObscure](https://github.com/openobscure/openobscure) - On-device privacy firewall for AI agents that detects and encrypts PII with FF1 format-preserving encryption before it reaches the LLM [![CI](https://github.com/openobscure/openobscure/actions/workflows/ci.yml/badge.svg)](https://github.com/openobscure/openobscure/actions/workflows/ci.yml)
