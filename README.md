...
* [datalogic-rs](https://github.com/GoPlasmatic/datalogic-rs) — High-performance, type-safe JSONLogic evaluation engine in Rust, ideal for business rules and dynamic filtering. [![crates.io](https://img.shields.io/crates/v/datalogic-rs.svg)](https://crates.io/crates/datalogic-rs)
