...
* [MoonProxyHQ/moonproxy-desktop](https://github.com/MoonProxyHQ/moonproxy-desktop) - Cross-platform GUI desktop client for FRP (frpc) intranet exposure. Turns exposing local services to the public internet into a single click. ![CI](https://github.com/MoonProxyHQ/moonproxy-desktop/actions/workflows/ci.yml/badge.svg) [![Release](https://github.com/MoonProxyHQ/moonproxy-desktop/actions/workflows/release.yml/badge.svg)](https://github.com/MoonProxyHQ/moonproxy-desktop/releases/latest)
