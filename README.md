...
* [Just-Code-NET/PolterType](https://github.com/Just-Code-NET/PolterType) - Tray app that detects typing in the wrong keyboard layout, switches the layout and retypes the word. Windows, macOS, Linux (Wayland included). [![CI](https://github.com/Just-Code-NET/PolterType/actions/workflows/ci.yml/badge.svg)](https://github.com/Just-Code-NET/PolterType/actions/workflows/ci.yml)
