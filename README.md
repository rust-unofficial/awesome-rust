...
* [chh-itt/burin](https://github.com/chh-itt/burin) - A retained-mode GUI framework where Signal<T> replaces the dependency graph. 60 widgets, dual GPU/CPU backend, Taffy incremental layout.
* [Qt](https://doc.qt.io)
