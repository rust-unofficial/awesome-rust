...
* [aguacero7/rkik](https://github.com/aguacero7/rkik) [[rkik](https://crates.io/crates/rkik)] -  CLI tool designed for stateless and passive NTP inspection, just as dig or ping are for DNS and ICMP. It supports async requests and continuous monitoring. ![crate](https://img.shields.io/crates/v/rkik?logo=rust)
