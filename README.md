...
* [mmgehlot/bitpolar](https://github.com/mmgehlot/bitpolar) [[bitpolar](https://crates.io/crates/bitpolar)] - Near-optimal vector quantization for semantic search and KV cache compression, implementing TurboQuant (ICLR 2026), PolarQuant, and QJL. [![crates.io](https://img.shields.io/crates/v/bitpolar.svg)](https://crates.io/crates/bitpolar) [![build](https://img.shields.io/github/actions/workflow/status/mmgehlot/bitpolar/ci.yml?branch=main)](https://github.com/mmgehlot/bitpolar/actions)
