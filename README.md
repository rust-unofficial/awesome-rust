...
* [dakera](https://github.com/dakera-ai/dakera-mcp) - Self-hosted AI agent memory server with decay-weighted vector recall, hybrid BM25+HNSW retrieval, and 83 MCP tools. Built on RocksDB with a knowledge graph layer — achieves 87.8% on the LoCoMo benchmark for long-term conversational memory.
