...
* [Atomic-Server](https://github.com/atomicdata-dev/atomic-server/) [[atomic-server](https://crates.io/crates/atomic_server)] - NoSQL graph database with realtime updates, dynamic indexing and easy-to-use GUI for CMS purposes. [![Release](https://github.com/rust-unofficial/awesome-rust?tab=readme-ov-file/badge.svg)](https://github.com/atomicdata-dev/atomic-server/actions)
