...
* [Octopus](https://github.com/xraph/octopus) — Schema-driven API gateway. Discovers upstreams via FARP and turns their OpenAPI/gRPC/GraphQL/AsyncAPI schemas into routes, with load balancing, health checks, JWT auth, rate limiting, TLS/mTLS, and Rhai scripting.
