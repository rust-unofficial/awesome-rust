...
* Socket.io
  * [Totodore/socketioxide](https://github.com/Totodore/socketioxide) [[socketioxide](https://crates.io/crates/socketioxide)] — A [socket.io](https://socket.io) server implementation in Rust that integrates with the Tower ecosystem and the Tokio stack. ![crates.io](https://img.shields.io/crates/v/socketioxide.svg) ![build badge](https://github.com/Totodore/socketioxide/actions/workflows/socketio-ci.yml/badge.svg) ![build badge](https://github.com/Totodore/socketioxide/actions/workflows/engineio-ci.yml/badge.svg)
