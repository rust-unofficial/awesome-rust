...
* [delta](https://crates.io/crates/git-delta) — A syntax-highlighter for git and diff output [<img src="https://travis-ci.com/dandavison/delta.svg?branch=master">](https://travis-ci.com/dandavison/delta)
