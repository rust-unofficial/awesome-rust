...
* [mdBook preprocessor - mermaid.js](https://github.com/badboy/mdbook-mermaid) - A preprocessor for mdBook to support mermaid.js graphs [![Deploy](https://github.com/badboy/mdbook-mermaid/actions/workflows/deploy.yml/badge.svg)](https://github.com/badboy/mdbook-mermaid/actions/workflows/deploy.yml) [![Tests](https://github.com/badboy/mdbook-mermaid/actions/workflows/tests.yml/badge.svg)](https://github.com/badboy/mdbook-mermaid/actions/workflows/tests.yml)
* [mdBook preprocessor - toc](https://github.com/badboy/mdbook-toc) - A preprocessor for mdBook to add automated table of contents [![Deploy](https://github.com/badboy/mdbook-toc/actions/workflows/deploy.yml/badge.svg)](https://github.com/badboy/mdbook-toc/actions/workflows/deploy.yml) [![Tests](https://github.com/badboy/mdbook-toc/actions/workflows/tests.yml/badge.svg)](https://github.com/badboy/mdbook-toc/actions/workflows/tests.yml)
* [mdBook preprocessor - plantuml](https://github.com/sytsereitsma/mdbook-plantuml) - A preprocessor for mdBook to support PlantUML graphs [![Build Status](https://travis-ci.com/sytsereitsma/mdbook-plantuml.svg?branch=master)](https://travis-ci.com/sytsereitsma/mdbook-plantuml)
