...
* [hongnoul/gwae](https://github.com/hongnoul/gwae) - Scrolling (niri-style) terminal multiplexer for orchestrating AI coding agents: panes never shrink, the strip scrolls sideways infinitely, with an OSC 133 heads-up display of running/idle/failed agents. [![CI](https://github.com/hongnoul/gwae/actions/workflows/ci.yml/badge.svg)](https://github.com/hongnoul/gwae/actions/workflows/ci.yml)
