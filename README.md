...
* [RustChain](https://github.com/Scottcjn/Rustchain) - AI-agent-native blockchain with Proof of Antiquity consensus that rewards vintage hardware; part of the DePIN ecosystem for distributed compute.
