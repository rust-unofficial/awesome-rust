...
* [T1mn/pad](https://github.com/T1mn/pad) - A tmux-native Rust control panel for Codex, Claude Code, Gemini CLI, and other terminal agents with live previews, pane jumps, notifications, and Telegram support.
