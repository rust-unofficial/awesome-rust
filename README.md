...
* [RustChain](https://github.com/Scottcjn/Rustchain) - Proof-of-Antiquity blockchain that rewards vintage hardware. Old computers earn more than new ones. Rust+Python hybrid chain supporting 15+ CPU architectures.
