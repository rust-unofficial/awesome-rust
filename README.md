...
* Fonts
  ...
  * [silly-tae/daegun](https://github.com/silly-tae/daegun) [[daegun](https://crates.io/crates/daegun)] - All-in-one text engine: parses TrueType and OpenType, shapes complex scripts, lays out, hints, rasterizes on CPU or GPU and subsets, with no dependencies
