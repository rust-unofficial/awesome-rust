...
* ORM [[orm](https://crates.io/keywords/orm)]
  ...
  * [kkharji/redis-om](https://github.com/kkharji/redis-om) [[CRATE](https://crates.io/crates/redis-om)] — Redis ORM-style library that reduce the amount of boilerplate code needed to leverage redis data structures. [![Build status][https://github.com/kkharji/redis-om/workflows/Continuous%20integration/badge.svg]][https://github.com/kkharji/redis-om/actions?query=workflow%3A%22Continuous+integration%22]
