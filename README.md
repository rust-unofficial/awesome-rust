...
* [nika](https://github.com/supernovae-st/nika) - Intent-as-code workflow engine for AI: author a reviewable DAG in YAML, audit cost/permits before running, keep tamper-evident traces after.
