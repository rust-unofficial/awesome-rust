...
* [gladius](https://codeberg.org/njskalski/bernardo/src/branch/master/docs/beta_release_notes/beta_1_release.md) - A command line, keyboard only, multicursor code editor with LSP and sane defaults.
