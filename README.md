...
* [discord-shield](https://github.com/bad-antics/nullsec-discord-shield) - Discord token hardening and anti-theft protection with AES-256-GCM encrypted vault, memory obfuscation, and grabber detection
