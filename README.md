...
* [reacherwu/diffhound](https://github.com/reacherwu/diffhound) - Zero-Noise AI PR Guard and anti-regression engine. Pure Rust (0 external crate dependencies) with retrospective causal retrieval for CI/CD.
