...
* [liuchong/hoverstare](https://github.com/liuchong/hoverstare) [[hoverstare](https://crates.io/crates/hoverstare)] — repo-aware AI code review bot: agentic multi-pass review with voting, precise inline PR comments, and incremental finding tracking. GitHub Action, App, or self-hostable webhook service
