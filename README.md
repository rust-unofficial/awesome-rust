...
* [rcspam/dictee](https://github.com/rcspam/dictee) - Push-to-talk voice dictation for Linux. 100% local, multilingual (25+ languages), speaker diarization. Rust backend on NVIDIA Parakeet via ONNX Runtime.
