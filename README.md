...
* [DirSorter](https://github.com/usmandevstuff/dir-sorter-rs) - rust app that automatically sorts a directory into 'category' based directories(gui in eframe/egui)
