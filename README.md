...
* [tomaka/rodio](https://github.com/tomaka/rodio) [![Build Status](https://travis-ci.org/tomaka/rodio.svg?branch=master)](https://travis-ci.org/tomaka/rodio) - A Rust audio playback library
