...
* [crw](https://github.com/us/crw) - An open-source web scraper built for AI agents. Single binary, built-in MCP server (stdio + HTTP), ~6 MB idle RAM, and Firecrawl-compatible API. [![CI](https://github.com/us/crw/actions/workflows/ci.yml/badge.svg)](https://github.com/us/crw/actions/workflows/ci.yml)
