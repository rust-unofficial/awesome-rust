...
* [juyterman1000/entroly](https://github.com/juyterman1000/entroly) - Auditable context control plane for AI coding agents. Compresses context by 70–95%, preserves KV cache alignment, and verifies answers locally using WITNESS verifier ($0, ~3ms). Includes MemoryOS for budget-aware semantic memory.
