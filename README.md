...
* [dev-sweeper](https://github.com/dvigo/dev-sweeper) - Extremely fast interactive CLI (TUI) to reclaim gigabytes of disk space by sweeping inactive project dependencies.
