...
* [jsongrep](https://github.com/micahkepe/jsongrep) - A fast search tool for JSON, YAML, TOML, and other serialization formats with an intuitive path query syntax.
