...
* Game Engines
  ...
  * [renew](https://github.com/renew-engine/renew) - A deterministic, code-first game engine: fixed-timestep simulation in fixed point, Vulkan rendering, and a command-line face on every capability [![Crates.io](https://img.shields.io/crates/v/renew-frame.svg)](https://crates.io/crates/renew-frame) [![license](https://img.shields.io/crates/l/renew-frame.svg)](https://github.com/renew-engine/renew/blob/main/LICENSE)
